...
The fastest way to install your Android-optimized bot without compiling on your phone:

```bash
curl -fsSL https://raw.githubusercontent.com/foxy1402/termuxclaw/main/install.sh | bash -s -- --prefer-prebuilt
```

This will automatically download the lightweight `aarch64-linux-android` release generated by your GitHub Actions and install it in seconds.

### Manual build (fallback)
If you haven't triggered a GitHub release yet, it will fallback to compiling on your phone (takes 10-40 minutes):
```bash
