...
mod tests {
    ...
    #[test]
    fn non_interactive_denies_unknown_tools_in_supervised() {
        // Default config is now Full; test with explicit supervised config.
        let config = AutonomyConfig {
            level: AutonomyLevel::Supervised,
            ..AutonomyConfig::default()
        };
        ...
        assert!(
            ...
            "unknown tool should need approval in supervised mode"
        );
    }
